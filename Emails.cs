...
namespace App_Final_Restaurante
{
    public static class Emails
    {
        public static void sendMail(string to, string asunto , string body)
        {
            ...
            string from = "tomoxclorox@gmail.com"; //correo de la empresa
            ...
            try
            {
                ...
                {
                    Credentials = new NetworkCredential(from, "cqthhlxtgpxjvayx"), //correo , contraseña de la cuenta de la empresa (Explicacion en el Word)
            ...
            catch (Exception ex)
            {
                throw new Exception("ERROR AL ENVIAR EL MENSAJE. \n \n " +
                    $"Por favor verifica tu conexión a internet y que tus datos sean correctos e intenta nuevamente: {ex}");
            }
        }
    }
}
